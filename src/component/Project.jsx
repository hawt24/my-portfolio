...
const Project = () => {
  const projects = [
    {
      img: project1,
      name: "A2SV (African to Silicon valley blog post)",
      github_link: "https://github.com/RealEskalate/2023-project-phase-starter-projects/tree/main/aastu/web/group-1",
